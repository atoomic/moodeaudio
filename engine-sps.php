 ...
 * 2016-08-28 2.7 TC
 * - breakout airplay volume array for debug log
 *
 */
...
const DEF_COVER = 'images/default-cover.jpg';
const SPS_COVER = 'images/spscover.';
const SPS_CACHE = '/var/www/spscache.json';
...
if (false === ($array = sdbquery('select value from cfg_engine where param="airplayactv"', cfgdb_connect()))) {
        ...
        switch ($tag) {
            ...
            case 'ssnc PICT':
				...
				if ($meta['imgurl'] != DEF_COVER) {
					// create image file
					if (file_put_contents('/var/www/' . $meta['imgurl'], $buf) === false) {
