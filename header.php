...
<div id="menu-top" class="ui-header ui-bar-f ui-header-fixed slidedown" data-position="fixed" data-role="header" role="banner">
	<div class="dropdown">
		...
		<ul class="dropdown-menu" role="menu" aria-labelledby="menu-settings">
			<li class="context-menu"><a href="#notarget" data-cmd="setforclockradio-m"><i id="clockradio-icon-m" class="icon-time sx clockradio-off-m"></i> Clock radio</a></li>
			<li class="context-menu menu-separator"><a href="#notarget" data-cmd="settimer"><i id="timer-icon-m" class="icon-moon sx timer-off-m"></i> Sleep Timer</a></li>
